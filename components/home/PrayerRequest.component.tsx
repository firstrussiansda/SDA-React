...
const PrayerRequest: React.FunctionComponent<WithTranslation> = ({
    t,
    tReady,
}) => {
    ...
    const localizedText = t('prayerRequest', {
        returnObjects: true,
    }) as PrayerRequestLocales;
                    ...
                    >
                        ...
                        <div className="row">
                            <div className="col form-group">
                                <label htmlFor="prayer_request">
                                    {localizedText.prayerNeed}
                                </label>
                                <textarea
                                    className="form-control"
                                    id="prayer_request"
                                    name="prayer_request"
                                    placeholder={
                                        localizedText.prayerNeedPlaceholder
                                    }
                                    rows={3}
                                    required={true}
                                />
